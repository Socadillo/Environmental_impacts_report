...
%%-----------------TITLE PAGE
  \include{sections/titlepage}                            %% Clears page and adds title page then clears page
...
%%-----------------ABSTRACT
  ...
  \include{sections/abstract}                             %% Clears page and adds abstract page then clears page
...
%%----------BODY
  ...
  \input{sections/introduction}                                   %% Adds introduction to report
  \input{sections/methods}                                        %% Adds methods to report
%  \input{sections/results}                                        %% Adds results to report
%  \input{sections/discussion}                                     %% Adds discussion to report

%  \input{sections/conclusion}                                     %% Adds conclusion to report
...
%  \include{sections/appendix}                                 %% Clear page and add appendix clear page
